    ...
    def post(self):
        ...
        try:
            ...
            if model_tag != NETWORK_MODEL_TAG:
                ...
                model_weights = torch.load(model_filepath, map_location=torch.device('cpu'))
            ...
            prediction_raw = preds_list[-1][0].cpu()
            features_raw = TFRM_L2NORM(torch.cat(feats_list, dim=1))[0].cpu()
